    ...
    public void setEmptyViewUI(int resId, String mEmptyText) {
        ...
        if (mTextEmptyView != null) {
            ...
            if (resId > 0) {
                ...
                mTextEmptyView.setPadding(0, 0, 0, PxUtil.dip2px(getContext(), 35));
//				mTextEmptyView.set
            }
    ...
    public void setEmptyView(View emptyView) {
        ...
        params.setMargins(0, PxUtil.dip2px(getContext(), 100), 0, 0);
    ...
    public void setEmptyViewText(String mEmptyText) {
        setEmptyViewUI(0, mEmptyText);//R.drawable.data_no
    }
